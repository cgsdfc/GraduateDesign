...
% ------ RUBER --------- %
%基于带参考的得分（Referenced Score）和无参考的得分（Unreferenced Score）的RUBER
%Referenced metric and Unreferenced metric Blended Evaluation Routine

Tao等人提出了Referenced Metric and Unreferenced Metric Blended Evaluation Routine指标\upcite{RUBER}，简称RUBER。
...
符号（表情符号，URL等等）\upcite{corpus_survey}。
