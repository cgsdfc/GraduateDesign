...
% ------------------------------------- %
Jiwei Li等人提出了一系列基于Seq2Seq框架的对话系统，包括
...
对于第一个难题，普遍认为，和机器翻译相比，对话生成的输出具有更高的熵（Entropy）。
...
\begin{table}[H]
    ...
    \end{tabular}
\end{table}
如表~\ref{tab:multiple_valid_responses}所示，合理的响应不唯一。
这种固有的多样性决定了评价响应生成系统的困难程度。
...
本课题延续了Liu等人的工作，对自动评价指标进行深入研究。
Liu等人已经研究了评价指标与人类评价的相关性，并且发现了它们的弱点；
本文进一步研究了评价指标之间的相关性，以及模型性能在不同指标和数据集上的一致性。
虽然，目前的评价指标尚不能和人类评价一样准确的衡量系统的性能，
但是对它们性质的研究将有助于开发和人类评价相关度更高的新指标。
% Merits of Auto Metric:
评价指标的准确度的提高将有助于客观的评价对话系统，提高开发速度和降低成本\upcite{
