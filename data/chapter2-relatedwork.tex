...
% ----------------- METEOR ----------------- %
METEOR，Metric for Evaluation of Translation with Explicit ORdering\upcite{METEOR}
...
这是一类建立在分布式假设\upcite{distributed_hypothesis,Mathematical_structures_of_language}（Distributed Hypothesis）上，
...
%自动摘要领域的ROUGE指标\upcite{ROUGE}也和人类评价具有较好的相关性。
