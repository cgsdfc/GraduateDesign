...
本领域目前存在两个难题：
一是如何合理评价面向闲聊的对话系统的性能\upcite{HowNot,Shang,deep_RL,deltaBLEU,ADEM}，
...
在技术性的Ubuntu对话数据集（Ubuntu Dialogue Corpus）\upcite{ubuntu_corpus}没有相关性。
...
并在三个具有代表性的公开数据集：Ubuntu对话数据集，OpenSubtitles和LSDSCC\upcite{LSDSCC}上进行了实验。
