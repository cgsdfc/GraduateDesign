...
\begin{table}[H]
    ...
    \begin{tabular}{llll}
        ...
        Twitter Triple Corpus\upcite{Ritter11,DCGM,MMI} & 大 & 短对话多领域闲聊
        & 是 \\
        OpenSubtitles\upcite{OPUS,opensub} & 大 & 电影字幕 & 是 \\
...
%\protected\footnote{Twitter相关的数据由Twitter隐私条款保护}
%\protected\footnote{http://www.opensubtitles.org}
...
% --------- Cornell & MovieDialogueCorpus --------- %

% -------- DailyDialog, MovieTriple, Movie-DiC, SubTle ------ %
