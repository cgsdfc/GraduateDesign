...
对话系统又可以分为生成式对话系统（Generative System）和检索式对话系统（Retrieval-Based System）\upcite{DBLP:journals/corr/SerbanLCP15,DBLP:conf/sigdial/LoweSNCP16}。
...
这两种方法各有优劣：检索式模型的输出没有语法错误并且可以限制输出的范围\upcite{DBLP:conf/sigdial/LoweSNCP16}，但是不能生成新句子；
